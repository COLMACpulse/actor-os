...
const CACHE='actor-os-pwa-v3_18_0';
const SHELL=['./','./index.html','./performer_camera_v08.js','./title.js','./readalong.js','./sides.js','./pdf.js','./reader.js','./slatemove.js','./compress.js',
